    ...
    <section className="bg-background py-24 md:py-32">
      <div className="mx-auto max-w-4xl px-4 md:px-8">
        ...
        <div className="relative mt-16 md:mt-20">
          <div className="absolute top-7 bottom-7 start-7 w-px bg-gradient-to-b from-navy/20 via-navy/15 to-navy/5 md:start-8" />
          ...
          >
            {steps.map((step, index) => (
              ...
              >
                <div className="relative z-10 flex size-14 shrink-0 items-center justify-center rounded-full bg-navy text-xl font-bold text-navy-foreground shadow-[0_12px_28px_-14px_rgba(15,23,42,0.55)] md:size-16 md:text-2xl">
                  {index + 1}
                </div>
                <div className="flex-1 pt-2 md:pt-3">
                  ...
                  <p className="mt-2 max-w-md text-[1.02rem] leading-relaxed text-muted-foreground">
                    {step.body}
                  </p>
                </div>
              </motion.li>
