...
export function WhatsAppCta({
  ...
  return (
    <a
      ...
      className={cn(
        "group/cta flex w-full items-center justify-center gap-2.5 rounded-full bg-whatsapp pe-1.5 text-whatsapp-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_1px_2px_rgba(15,23,42,0.08),0_10px_22px_-14px_rgba(15,23,42,0.4)] transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_1px_2px_rgba(15,23,42,0.1),0_22px_44px_-16px_rgba(15,23,42,0.5)] active:scale-[0.98] sm:gap-3 sm:pe-2 sm:inline-flex sm:w-auto",
        isLarge
